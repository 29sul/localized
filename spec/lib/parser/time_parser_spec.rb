...
describe Localized::Parser::TimeParser do
  context 'en locale' do
    ...
    describe '#localize' do
      it { expect(subject.localize(Time.utc(2010, 10, 25, 1, 33))).to eq 'Mon, 25 Oct 2010 01:33:00 +0000' }
    end
  end
  ...
  context 'pt-BR locale' do
    ...
    describe '#localize' do
      it { expect(subject.localize(Time.new(2014, 2, 14, 17, 55))).to eq '14/02/2014 17:55' }
    end
  end
end
